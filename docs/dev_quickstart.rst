...
Conventional files : CODE_OF_CONDUCT, CONTRIBUTING, LICENSE, README
    These are the conventional locations of the community :doc:`Code of Conduct
    </code_of_conduct>`, the :doc:`Contributing Guide </contributing>`, the
    source code license, and the readme. The first two are just symbolic links
    into the documentation directory. The license is Apache 2.0.
